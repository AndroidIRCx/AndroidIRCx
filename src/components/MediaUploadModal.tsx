      ...
      handler: async () => {
        ...
        if (Platform.OS === 'android') {
          try {
            ...
            console.error(
              '[MediaUploadModal] Video recording permission error:',
              err,
            );
            return;
          }
      ...
      handler: async () => {
        ...
        if (Platform.OS === 'android') {
          try {
            ...
            if (!checkResult) {
              ...
              if (granted !== PermissionsAndroid.RESULTS.GRANTED) {
                Alert.alert(
                  t('Error'),
                  t(
                    'Microphone permission is required to record voice messages. Please allow microphone access in app settings.',
                  ),
                );
                return;
              }
            ...
            console.error(
              '[MediaUploadModal] Microphone permission error:',
              err,
            );
            Alert.alert(
              t('Error'),

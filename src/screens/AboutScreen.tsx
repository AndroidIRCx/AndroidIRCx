  ...
  const socialLinks = [
    {
      id: 'instagram',
      label: 'Instagram',
      url: 'https://www.instagram.com/androidircx/',
      icon: 'instagram',
      brand: true,
    },
    {
      id: 'facebook',
      label: 'Facebook',
      url: 'https://www.facebook.com/androidircx',
      icon: 'facebook',
      brand: true,
    },
    {
      id: 'tiktok',
      label: 'TikTok',
      url: 'https://www.tiktok.com/@androidircx',
      icon: 'tiktok',
      brand: true,
    },
    {
    ...
    },
    {
      id: 'reddit',
      label: 'Reddit',
      url: 'https://www.reddit.com/r/AndroidIRCx',
      icon: 'reddit-alien',
      brand: true,
    },
    {
    ...
    },
    {
      id: 'linkedin',
      label: 'LinkedIn',
      url: 'https://www.linkedin.com/company/androidircx',
      icon: 'linkedin',
      brand: true,
    },
    {
      id: 'mastodon',
      label: 'Mastodon',
      url: 'https://mastodon.social/@androidircx',
      icon: 'mastodon',
      brand: true,
    },
    {
    ...
    },
    {
      id: 'coderlegion',
      label: 'CoderLegion',
      url: 'https://coderlegion.com/user/AndroidIRCx',
      icon: 'code',
      solid: true,
    },
  ];

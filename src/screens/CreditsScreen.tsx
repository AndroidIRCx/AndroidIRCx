        ...
        >
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.sectionDescription}>
              {t(
                'Special thanks to everyone who helped translate AndroidIRCX into different languages.',
              )}
            </Text>
          </View>
              ...
              <View style={styles.translatorsContainer}>
                {langCredit.translators.map((translator, tIndex) => (
                  <View key={tIndex} style={styles.translatorBadge}>
                    {translator.url ? (
                      <TouchableOpacity
                        onPress={() => handleOpenURL(translator.url!)}
                      >
                        <Text style={[styles.translatorNick, styles.link]}>
                          {translator.nick}
                        </Text>
                      </TouchableOpacity>
                    ) : (
                      <Text style={styles.translatorNick}>
                        {translator.nick}
                      </Text>
                    )}
                  </View>

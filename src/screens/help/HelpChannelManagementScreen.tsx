...
export const HelpChannelManagementScreen: React.FC<
  HelpChannelManagementScreenProps
> = ({ visible, onClose }) => {
  const t = useT();
  ...
  return (
    <HelpScreenBase
      visible={visible}
      onClose={onClose}
      title={t('Channel Management Guide')}
    >
      <HelpSection title={t('Channel Basics')}>
        ...
        <HelpSubsection title={t('Channel Types')}>
          ...
          <HelpBullet>
            {t('Secret Channels - Hidden from channel list')}
          </HelpBullet>
          <HelpBullet>
            {t('Moderated Channels - Only voiced users can speak')}
          </HelpBullet>
        </HelpSubsection>
      </HelpSection>
      ...
      <HelpSection title={t('Channel Modes')}>
        <HelpSubsection title={t('User Modes')}>
          ...
          <HelpBullet>
            {t('+v (Voice) - Can speak in moderated channels')}
          </HelpBullet>
          <HelpBullet>{t('+h (Half-op) - Limited operator powers')}</HelpBullet>
          <HelpBullet>
            {t('+q (Owner) - Channel owner (some networks)')}
          </HelpBullet>
          <HelpBullet>
            {t('+a (Admin) - Channel admin (some networks)')}
          </HelpBullet>
        </HelpSubsection>
      ...
      <HelpSection title={t('Channel Settings')}>
        <HelpSubsection title={t('Moderated (+m)')}>
          <HelpParagraph>
            {t('Only ops and voiced users can speak:')}
          </HelpParagraph>
      ...
      <HelpSection title={t('Advanced Management')}>
        <HelpSubsection title={t('Channel Registration')}>
          <HelpParagraph>
            {t('Register channel with ChanServ (if available):')}
          </HelpParagraph>
          <HelpCode>
      ...
      <HelpSection title={t('Best Practices')}>
        <HelpSubsection title={t('Security')}>
          <HelpBullet>
            {t('Set +n and +t modes for public channels')}
          </HelpBullet>
        ...
        <HelpSubsection title={t('Moderation')}>
          ...
          <HelpBullet>
            {t('Use +q (quiet) before +b (ban) for first offenses')}
          </HelpBullet>
        ...
        <HelpSubsection title={t('Growth')}>
          ...
          <HelpBullet>
            {t('Make channel public (+p/-s) if you want growth')}
          </HelpBullet>
